...
public final class RssSourcesUrls {
    ...
    public static final List<RssSource> RSS_URLS = new ArrayList<>(List.of(
            ...
            new RssSource("https://www.aljazeera.net/aljazeera/rss.xml", RssPriorityConstraint.MEDIUM.getId(), 10, 60, 5),
            new RssSource("https://www.youm7.com/rss", RssPriorityConstraint.MEDIUM.getId(), 10, 60, 5),
